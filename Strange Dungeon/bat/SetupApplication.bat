...
:: Android packaging
set AND_CERT_NAME="Strange Dungeon"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\StrangeDungeon.p12
...
set IOS_PROVISION=cert\StrangeDungeon.mobileprovision
...
set APP_ID=air.StrangeDungeon.StrangeDungeon

:: Output packages
set DIST_PATH=dist
set DIST_NAME=StrangeDungeon
