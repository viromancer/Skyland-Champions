package punk.ui.skins
{
	 ...
	 */		
	public class BrownGrey extends PunkSkin
	{
		/**
		 * The asset to use for the skin image. 
		 */		
		[Embed(source="browngrey.gif")] protected const I:Class;
		
		/**
		 * Constructor. 
		 */		
		public function BrownGrey()
		{
			super();
			
			punkButton = new PunkSkinButtonElement(gy(0, 0), gy(20, 0), gy(40, 0), gy(20, 0), {color: 0x000000, size: 8});
